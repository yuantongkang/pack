...
// Source: github.com/buildpacks/pack (interfaces: BuildpackDownloader)
...
func (m *MockBuildpackDownloader) Download(arg0 context.Context, arg1 string, arg2 BuildpackDownloadOptions) (dist.Buildpack, []dist.Buildpack, error) {
	m.ctrl.T.Helper()
